...
grid.arrange(t1,t2,t3,t4,t5, top = textGrob("Top Biograms Used for Tweets about Candidate", gp = gpar(fontsize = 20, face = "bold")))
#############################################
...
grid.arrange(c1,c2,c3,c4,c5,top = textGrob("Biograms of Candidates Tweets", gp = gpar(fontsize = 20, face = "bold")))
###############